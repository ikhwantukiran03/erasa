                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg">
                                <h3 class="text-lg font-semibold text-gray-800 mb-3">Item Details</h3>
                                <p><span class="font-medium">Item:</span> {{ $customization->packageItem->item ? $customization->packageItem->item->name : 'Item not found' }}</p>
                                <p><span class="font-medium">Category:</span> {{ $customization->packageItem->item && $customization->packageItem->item->category ? $customization->packageItem->item->category->name : 'Category not found' }}</p>
                        ...
                        <div>
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg">
                                ...
                                <p><span class="font-medium">Event Date:</span> {{ $customization->booking->booking_date->format('M d, Y') }}</p>
                                <p><span class="font-medium">Session:</span> {{ ucfirst($customization->booking->session) }}</p>
                                <p><span class="font-medium">Type:</span> {{ ucfirst($customization->booking->type) }}</p>
                                <p><span class="font-medium">Venue:</span> {{ $customization->booking->venue ? $customization->booking->venue->name : 'Venue not found' }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            <p><span class="font-medium">Name:</span> {{ $customization->booking->user ? $customization->booking->user->name : 'User not found' }}</p>
                            <p><span class="font-medium">Email:</span> {{ $customization->booking->user ? $customization->booking->user->email : 'Email not available' }}</p>
                            <p><span class="font-medium">WhatsApp:</span> {{ $customization->booking->user ? $customization->booking->user->whatsapp : 'WhatsApp not available' }}</p>
                        </div>
