        ...
        <div class="mt-8 bg-white rounded-lg shadow overflow-hidden">
            ...
            <div class="p-6">
                ...
                <div class="mb-6 flex flex-wrap gap-2">
                    <a href="{{ route('staff.customizations.index', ['status' => 'pending']) }}" class="px-4 py-2 rounded-full text-sm {{ $status === 'pending' ? 'bg-yellow-500 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300' }} transition">
                        Pending
                    </a>
                    <a href="{{ route('staff.customizations.index', ['status' => 'approved']) }}" class="px-4 py-2 rounded-full text-sm {{ $status === 'approved' ? 'bg-green-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300' }} transition">
                        Approved
                    </a>
                    <a href="{{ route('staff.customizations.index', ['status' => 'rejected']) }}" class="px-4 py-2 rounded-full text-sm {{ $status === 'rejected' ? 'bg-red-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300' }} transition">
                        Rejected
                    </a>
                    <a href="{{ route('staff.customizations.index') }}" class="px-4 py-2 rounded-full text-sm {{ !$status ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300' }} transition">
                        All Requests
                    </a>
                </div>
