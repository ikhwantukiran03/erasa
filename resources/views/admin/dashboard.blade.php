        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ \App\Models\Promotion::where('start_date', '<=', now())->where('end_date', '>=', now())->count() }}</p>
                </div>
            </div>
            <a href="{{ route('admin.promotions.index') }}" class="mt-4 inline-block text-sm text-pink-600 hover:underline">Manage promotions →</a>
        </div>
