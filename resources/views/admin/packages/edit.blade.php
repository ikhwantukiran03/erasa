                                        ...
                                        <div class="flex items-start">
                                            <div class="mr-2 mt-1">
                                                <input 
                                                    ...
                                                    {{ old("items.{$item->id}.selected", isset($selectedItems[$item->id])) ? 'checked' : '' }}
                                                >
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <div class="mt-2">
                                                    ...
                                                    >{{ old("items.{$item->id}.description", $selectedItems[$item->id] ?? '') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        let priceCount = {{ max(count($package->prices), 1) }};
