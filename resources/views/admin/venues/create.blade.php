...
@section('title', 'Add New Venue - Enak Rasa Wedding Hall')
...
<div class="bg-gray-50 py-6">
    <div class="container mx-auto px-4">
        ...
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-3xl font-display font-bold text-dark">Add New Venue</h1>
                <p class="text-gray-600 mt-2">Create a new wedding venue location</p>
            </div>
        ...
        <div class="mt-6 bg-white rounded-lg shadow overflow-hidden">
            <div class="p-6">
                ...
                <form action="{{ route('admin.venues.store') }}" method="POST" class="max-w-4xl">
                    @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input 
                                    ...
                                    placeholder="Enak Rasa Grand Ballroom"
                                    autofocus
                                >
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea 
                                    ...
                                    placeholder="Provide a detailed description of the venue..."
                                    required
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input 
                                    ...
                                    placeholder="123 Wedding Hall Street"
                                >
