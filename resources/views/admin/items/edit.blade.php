    ...
    <div class="container mx-auto px-4">
        ...
        <nav class="flex mb-5" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                        <span class="ml-1 text-gray-500 md:ml-2">Edit Item</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="mt-6 bg-white rounded-lg shadow overflow-hidden">
            <div class="p-6">
                ...
                <form action="{{ route('admin.items.update', $item) }}" method="POST" class="max-w-3xl">
                    @csrf
                    @method('PUT')
                    
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label for="name" class="block text-dark font-medium mb-1">Item Name <span class="text-red-500">*</span></label>
                            <input 
                                type="text" 
                                id="name" 
                                name="name" 
                                ...
                                autofocus
                            >
                            <p class="mt-1 text-sm text-gray-500">Enter a clear and descriptive name</p>
                        </div>
                        
                        <div>
                            <label for="category_id" class="block text-dark font-medium mb-1">Category <span class="text-red-500">*</span></label>
                            <select 
                                id="category_id" 
                                name="category_id" 
                                required 
                            ...
                            <p class="mt-1 text-sm text-gray-500">Select the category this item belongs to</p>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Add any additional information or specifications</p>
                        </div>
                    </div>
