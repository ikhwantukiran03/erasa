...
@section('title', 'Edit Category - Enak Rasa Wedding Hall')
...
<div class="bg-gray-50 py-6">
    <div class="container mx-auto px-4">
        ...
        <nav class="flex mb-5" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                        <span class="ml-1 text-gray-500 md:ml-2">Edit Category</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-3xl font-display font-bold text-dark">Edit Category</h1>
                ...
                <form action="{{ route('admin.categories.update', $category) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 gap-6 max-w-2xl">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500">Add details about what this category contains</p>
                        </div>
                    </div>
