...
@section('title', 'Edit Promotion - Enak Rasa Wedding Hall')
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="mb-8">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                <div>
                    <h1 class="text-4xl font-display font-bold text-primary mb-2">Edit Promotion</h1>
                    <p class="text-gray-600 text-lg">Update your promotion details</p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
            <form action="{{ route('admin.promotions.update', $promotion) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="bg-gradient-to-r from-primary/10 to-primary/5 px-8 py-6 border-b border-gray-100">
                    ...
                    <p class="text-gray-600">Update your promotion information</p>
                </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            >
                                ...
                                @foreach($packages as $package)
                                    <option value="{{ $package->id }}" {{ old('package_id', $promotion->package_id) == $package->id ? 'selected' : '' }}>
                                        {{ $package->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="lg:col-span-2">
                            ...
                            @if($promotion->cloudinary_image_url)
                                <div class="mb-4">
                                    <img src="{{ $promotion->cloudinary_image_url }}" alt="Current promotion image" class="rounded-lg shadow-md" style="max-height: 200px;">
                                </div>
                            @endif
                            ...
                            <p class="mt-1 text-sm text-gray-500">Upload a new image or keep the current one</p>
                        </div>
                    </div>
