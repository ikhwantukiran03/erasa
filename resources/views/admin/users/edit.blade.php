        ...
        <div class="mt-6 bg-white rounded-lg shadow overflow-hidden">
            <div class="p-6">
                ...
                <form action="{{ route('admin.users.update', $user) }}" method="POST" class="max-w-3xl">
                    ...
                    <div class="mb-6 bg-yellow-50 border-l-4 border-yellow-500 text-yellow-700 p-4 rounded-md">
                        <div class="flex">
                            ...
                            <div>
                                ...
                                <p class="text-sm mt-1">Leave password fields empty to keep the current password.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500">Re-enter the new password to confirm</p>
                        </div>
                    </div>
