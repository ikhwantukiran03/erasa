                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden sticky top-24 border border-gray-100">
                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-3 mb-6">
                            ...
                            <a href="https://wa.me/60123456789?text=I'm interested in {{ $package->name }} at {{ $package->venue->name }}" target="_blank" class="block w-full bg-green-500 text-white text-center py-3 rounded-lg hover:bg-opacity-90 transition text-sm font-medium flex items-center justify-center">
                        ...
                        <div class="text-center p-4 bg-gray-50 rounded-lg">
                            ...
                            <p class="font-medium text-gray-800 text-lg">+60 123 456 789</p>
                        </div>
                    </div>
                </div>
            </div>
